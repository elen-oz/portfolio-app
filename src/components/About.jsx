        ...
        <div className={styles.content}>
          ...
          <div>
            <p>
              ...
              in&nbsp;<em>React</em> and <em>JavaScript</em>, I&apos;m dedicated
              to delivering top-quality solutions.
              <br />
              <br />
              Eager for new opportunities and collaborations, let&apos;s create
              exceptional digital applications together!
            </p>
          </div>
        </div>
      </div>
