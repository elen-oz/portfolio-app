...
const data = [
  {
    ...
    description:
      '<p>This is a food ordering application built with React.js, CSS, and HTML. The application allows users to browse through a menu, select their desired items, and place an order.</p><p>Features</p><ul ><li>Browse through a list of available food items</li><li>Add desired items to a shopping cart</li><li >Place an order for the selected items</li></ul>',
  },
  {
    id: 2,
    name: 'RSS Aggregator',
  ...
  },
  {
    ...
    description:
      '<p> Grin and Baste It is a cooking site that provides recipes and cooking tips for food enthusiasts. This project is built with React.js, CSS, and HTML. </p> <p>Features</p> <ul> <li> <strong>Add/Remove Items</strong>: The application allows users to add and delete recipes. </li> <li> <strong>Theme Switching</strong>: The application includes a feature to switch between different color themes. </li> <li> <strong>Firestore Integration</strong>: The application uses Firestore for storing and retrieving data. </li> </ul>',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description:
      '<p> My Money is a web application designed to help users keep track of their expenses. This project is built with React and uses Firebase for backend services. </p> <p>Features</p> <ul> <li> <strong>Interaction with Firebase</strong>: The application uses Firebase for backend services. </li> <li> <strong>User Registration and Login</strong>: The application supports user registration and login. </li> <li> <strong>Adding and Deleting Records</strong>: Users can add and delete their own expense records. </li> </ul>',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    live: null,
    description:
      '<p> Brain Games is a collection of five mini-games designed to challenge the users mental agility. Each game begins with a greeting, personalized with the users name, and consists of three rounds. </p> <p>Games</p> <ul> <li> <strong>Brain Even</strong>: The game asks the user to determine if a number is even. </li> <li> <strong>Brain Calc</strong>: The game presents an arithmetic operation (addition, subtraction, multiplication) on two numbers and asks the user to calculate the result. </li> <li> <strong>Brain GCD</strong>: The game asks the user to find the greatest common divisor of two numbers. </li> <li> <strong>Brain Progression</strong>: The game presents an arithmetic progression with one number missing and asks the user to identify the missing number. </li> <li> <strong>Brain Prime</strong>: The game asks the user to determine if a number is prime. </li> </ul>',
  },
];
